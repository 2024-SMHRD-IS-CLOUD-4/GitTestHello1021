document.addEventListener('DOMContentLoaded', function() {
	...
	const items = document.querySelectorAll('#subContainer2_2_right, .image-container, #sg_button, #btn1, #btn2, #btn3, #btn4, #btn1_h, #btn2_h, #btn3_h, #btn4_h, #profile');
	items.forEach(item => {
