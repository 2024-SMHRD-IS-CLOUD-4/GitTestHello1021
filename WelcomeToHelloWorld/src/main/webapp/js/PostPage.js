document.addEventListener('DOMContentLoaded', function () {
	...
	btn1_h: "게시물을 <br><br> 올립니다!",
	btn2_h: "게시물 작성을 <br><br> 취소합니다.",
	...
	subContainer2_2_right:"클릭하여<br><br> 사진을<br><br>불러옵니다!"	,
		textarea:"글을 <br><br>작성하세요"
	...
	const items = document.querySelectorAll('#subContainer1, #textarea, #subContainer2_2_right, .image-container, #sg_button, #btn1, #btn2, #btn3, #btn4, #btn1_h, #btn2_h, #btn3_h, #btn4_h, #profile');
	items.forEach(item => {
